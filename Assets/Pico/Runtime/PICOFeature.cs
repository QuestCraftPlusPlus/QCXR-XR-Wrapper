...
namespace Unity.XR.OpenXR.Features.PICOSupport
{
    ...
    {
        public const string PicoExtensionList = "XR_PICO_configuration";
        public static string SDKVersion = "1.1.3_Preview";
            ...
            rules.Add(new ValidationRule(this)
            {
                ...
                checkPredicate = () =>
                {
                    ...
                    foreach (var feature in settings.GetFeatures<OpenXRInteractionFeature>())
                    {
                        if (feature.enabled)
                        {
                            if ((feature is PICONeo3ControllerProfile) || (feature is PICO4ControllerProfile) || (feature is EyeGazeInteraction))
