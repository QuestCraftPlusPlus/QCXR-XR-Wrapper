...
namespace YVR.Core.Test
{
    ...
    public class YVRLayerCreateDestroyTests
    {
        ...
        {
            YVRLayerCreateInfo createInfo = new YVRLayerCreateInfo(-1, 400, 400, 1);
        ...
        private static int[] bufferCount = new int[] {1, 2, 3};

        [UnityTest, Category("CompositeLayer")]
        public IEnumerator CreateLayer_SwapBufferCount_GetDifferentColorHandles([ValueSource(nameof(bufferCount))] int swapBufferCount)
        {
            ...
            YVRLayerCreateInfo createInfo = new YVRLayerCreateInfo(-1, 400, 400, swapBufferCount);
            ...
            m_AndroidHandler.CreateLayerAsync(createInfo, (layerId) =>
            {
                ...
                {
                    colorHandlesArray[i] = m_AndroidHandler.GetLayerColorHandle(m_LayerId);
                    m_AndroidHandler.SwapBufferLayer(m_LayerId);
                }
            ...
            m_AndroidHandler.DestroyLayerAsync(m_LayerId, () => { afterDestroyLayerCount = m_AndroidHandler.GetLayersCount(); });
            yield return null;
        ...
        [UnityTest, Category("CompositeLayer")]
        public IEnumerator CreateLayer_SeveralLayerInARow_GetDifferenceLayerIds([ValueSource(nameof(requiredCreateCount))] int createCount)
        {
            ...
            {
                int index = i;
                m_AndroidHandler.DestroyLayerAsync(createdLayers[index], () => destroyedLayers.Add(createdLayers[index]));
            }
        ...
        public IEnumerator DestroyLayer_NonCreatedLayer_LayerCountRemain()
        {
            ...
            m_AndroidHandler.DestroyLayerAsync(-1, () => currentLayersCount = m_AndroidHandler.GetLayersCount());
            yield return null;
