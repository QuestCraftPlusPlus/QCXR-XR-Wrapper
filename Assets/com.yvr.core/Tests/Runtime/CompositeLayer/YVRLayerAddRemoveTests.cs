...
namespace YVR.Core.Test
{
    ...
    public class YVRLayerAddRemoveTests
    {
        ...
        public IEnumerator AddLayer_NonAddLayer_LayerCountIncreasedByOne()
        {
            ...
            int layerId = -1;
            YVRLayerCreateInfo createInfo = new YVRLayerCreateInfo(1, 20, 20, 3)
            {
            ...
            m_AndroidHandler.DestroyLayerAsync(layerId, () => currentLayersCount = m_AndroidHandler.GetLayersCount());
            yield return null;
        }
        ...
        public IEnumerator RemoveLayer_AddedLayer_LayerCountDecreaseByOne()
        {
            ...
            m_AndroidHandler.DestroyLayerAsync(layerId, () => afterDestroyLayerCount = m_AndroidHandler.GetLayersCount());
            yield return null;
        }
        ...
        public IEnumerator AddLayer_RemoveLayer_SeveralCreatedLayerInARow_LayerCountCorrect([ValueSource(nameof(requiredCreateCount))] int createCount)
        {
            ...
            for (int i = 0; i < createCount; i++)
            {
                m_AndroidHandler.DestroyLayerAsync(createdLayers[i], () => { afterDestroyedLayersCount = m_AndroidHandler.GetLayersCount(); });
            }
