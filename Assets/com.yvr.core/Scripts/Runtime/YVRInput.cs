...
namespace YVR.Core
{
    ...
    public static partial class YVRInput
    {
        ...
        {
            Unsupported = 0, LeftHanded = 1, RightHanded = 2,
        }

        private static YVRControllerBase[] controllersList = null;
        ...
        private static Dictionary<ControllerType, uint> controllerType2IndexMap = new Dictionary<ControllerType, uint>()
        {
        ...
        static YVRInput()
        {
            controllersList = new YVRControllerBase[]
            {
        ...
        public static void Update()
        {
            ...
            foreach (YVRControllerBase controller in controllersList)
            {
                connectedControllersType |= controller.Update();
        ...
        {
            return GetResolvedControllerData(controllerMask, (controller) => controller.isCharging) == 1;
        }
        ...
        public static ControllerType GetPrimaryController()
        {
            ...
            ControllerType controllerType = controllerType2IndexMap.First(kv => kv.Value == controllerMask).Key;
        ...
        {
            YVRPlugin.Instance.SetPrimaryController(controllerType2IndexMap[controllerType]);
        }
