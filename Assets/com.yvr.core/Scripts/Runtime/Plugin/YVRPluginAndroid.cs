...
namespace YVR.Core
{
    ...
    public class YVRPluginAndroid : YVRPlugin
    {
        ...
        [DllImport("yvrplugin")]
        private static extern int YVRGetPrimaryController(ref uint controllerMask);

        [DllImport("yvrplugin")]
        private static extern int YVRSetPrimaryController(uint controllerMask);
    ...
    YVRSetDevelopmentBuildMode(true);
        ...
        public override bool GetHeadsetPositionTracked() { return YVRGetHeadsetPositionTracked(); }

        public override bool GetHeadsetOrientationTracked() { return YVRGetHeadsetOrientationTracked(); }
        ...
        public override bool IsPowerSavingActive() { return YVRIsPowerSavingActive(); }
        ...
        public override int GetPrimaryController(ref uint controllerMask)
        {
            return YVRGetPrimaryController(ref controllerMask);
        }

        public override int SetPrimaryController(uint controllerMask)
        {
            return YVRSetPrimaryController(controllerMask);
        }
    }
}