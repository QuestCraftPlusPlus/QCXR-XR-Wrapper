...
namespace YVR.Utilities
{
    ...
    {
        /// <summary>
        /// Using the elements of an Array to form a string
        /// </summary>
        /// <param name="source"> The Array whose elements will form the string </param>
        /// <returns> Formed string in format "{firstElement.ToString()}, {secElement.ToString()}, ...." </returns>
