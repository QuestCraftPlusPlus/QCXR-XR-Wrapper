...
{
    [SerializeField] public Material _overdrawOpaqueMaterial = null;
    [SerializeField] public Material _overdrawTransparentMaterial = null;
    ...
    protected override ScriptableRenderer Create() { return new OverdrawRenderer(this); }
}
#endif